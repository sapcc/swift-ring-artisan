...
goimports: FORCE
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/swift-ring-artisan\e[0m\n"
	@goimports -w -local https://github.com/sapcc/swift-ring-artisan internal/ $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
...
help: FORCE
	...
	@printf "  \e[36mbuild/swift-ring-artisan\e[0m     Build swift-ring-artisan.\n"
